...
class JBossHelper(object):
    ...
    def __init__(self, url="http://localhost:11090/management", auth="eam:eam"):
        self.url = url
...
if __name__=="__main__":
    jboss = JBossHelper(auth="eam:eam")
    ...
    mdbs = jboss.get_mdbs_by_deployment("eamlogin.war")
    tabulate_mdb(mdbs, tablefmt='grid')

    print("# MDB Delivery Active?")
    jboss.get_mdb_status('eamlogin.war',['HelloWorldQueueMDB','HelloWorldQTopicMDB'])
